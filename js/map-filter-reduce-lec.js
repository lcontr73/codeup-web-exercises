...
console.log("Sports that have more than 8 characters : ", longSports)
console.log("Filtered: ", ballSportsFilter);


// ========== MINI-EXERCISE
// TODO: Find products that have a price of 50 or less.
let priceLessFifty = products.filter(product => product.price < 50);
console.log("Items under $50: ", priceLessFifty)
...
// }, 0);
//
// let gradeAvg = gradeTotal / grades.length;
//
